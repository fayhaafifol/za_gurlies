...
import 'package:petts/firebase_Auth_services.dart';
import 'package:petts/user.dart';
import 'main.dart';
...
setState(() {
        ...
        decoration:  InputDecoration(
          ...
          CupertinoButton(
            ...
            btnOkOnPress: () {},
                ...
                AwesomeDialog(
                  ...
                  animType: AnimType.rightSlide,
                  title: 'Error',
                  desc: 'please enter right number.',
                  btnCancelOnPress: () {},
                  btnOkOnPress: () {},
                ).show();
          ...
          StreamBuilder<QuerySnapshot>(
            ...
            builder: (context,snapshot){
              ...
              if(snapshot.hasData){
                final vet=snapshot.data?.docs.reversed.toList();
                for(var client in vet!){
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<GlobalKey<ScaffoldState>>('_scaffoldKey', _scaffoldKey));
  }
}
