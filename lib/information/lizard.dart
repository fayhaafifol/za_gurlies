...
class Lizard extends StatelessWidget {
  const Lizard({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Lizards", style: TextStyle(fontSize: 26)),
                        ...
                        child: InkWell(
                          ...
                          child:Container(
                            ...
                            child:Column(
                              ...
                              children:[
                                Ink.image(image: AssetImage("assets/lizerd.jpg",),
                                  height: 145,
                                  width: 170,
                                  fit: BoxFit.cover,
                                  //child: Center(
                                ...
                                SizedBox(height: 6),
                                Text("Green Iguana",style: TextStyle(fontSize: 21),),
                              ],
                            ),
                          ),
                        ),
                          ...
                          child:Container(
                            ...
                            child:Column(
                              ...
                              children:[
                                ...
                                SizedBox(height: 6),
                                Text("Chameleon",style: TextStyle(fontSize: 23),),
                              ],
                            ),
                          ),
                        ),
                          ...
                          child:Container(
                            ...
                            child:Column(
                              ...
                              children:[
                                ...
                                SizedBox(height: 6),
                                Text("Chinese Water \nDragons",style: TextStyle(fontSize: 21),),
                              ],
                            ),
                          ),
                        ),
                          ...
                          child:Container(
                            ...
                            child:Column(
                              ...
                              children:[
                                ...
                                SizedBox(height: 6),
                                Text("Savannah Moitors",style: TextStyle(fontSize: 19),),
                              ],
                            ),
                          ),
                        ),
                          ...
                          child:Container(
                            ...
                            child:Column(
                              ...
                              children:[
                                ...
                                SizedBox(height: 6),
                                Text("Caiman",style: TextStyle(fontSize: 21),),
                              ],
                            ),
                          ),
                        ),
